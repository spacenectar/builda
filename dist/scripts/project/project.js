...
exports.default = async ({ presetAnswers, appName, pathName, packageManager }) => {
    ...
    if (moduleType === 'remote') {
        module = await (0, helpers_1.addRemoteModule)((0, helpers_1.convertRegistryPathToUrl)(prefabPath), rootDir);
    }
            ...
            if (bp.location === 'prefab') {
                ...
                blueprintPromises.push(new Promise((resolve) => {
                    ...
                    if (bluePrintType === 'remote') {
                        (0, helpers_1.addRemoteModule)((0, helpers_1.convertRegistryPathToUrl)(bp.location), rootDir);
                    }
                    resolve(blueprint);
                }));
            }
