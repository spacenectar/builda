...
exports.default = [
    ...
    },
    {
        ...
        message: 'Which blueprint module do you want to install? (this can be changed later)',
        choices: [
            {
        ...
        default: 'typescript',
        when: (answers) => answers.buildFromPrefab === false
    },
    {
        type: 'input',
        name: 'blueprintUrl',
    ...
    },
    {
        ...
        default: '',
        when: (answers) => answers.customBlueprint
    }
];
