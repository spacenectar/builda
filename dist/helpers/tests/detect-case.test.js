...
describe('detect() function', () => {
    ...
    test("should return 'kebab' when input is 'my-component'", () => {
        const string = (0, string_functions_1.detectCase)('my-component');
    ...
    test("should return 'snake' when input is 'my_component'", () => {
        const string = (0, string_functions_1.detectCase)('my_component');
    ...
    test("should return 'unknown' when input is '@My 3Component'", () => {
        const string = (0, string_functions_1.detectCase)('@My 3Component');
