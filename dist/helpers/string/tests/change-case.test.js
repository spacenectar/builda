...
describe('changeCase() convert from kebab case', () => {
    test('Kebabcase text renders in sentence case', () => {
        const string = (0, change_case_1.changeCase)('my-component', 'sentenceCase');
        expect(string).toEqual('My component');
    });
    test('Kebabcase text renders in kebab case', () => {
        const string = (0, change_case_1.changeCase)('my-component', 'kebabCase');
        expect(string).toEqual('my-component');
    });
    test('Kebabcase text renders in pascal case', () => {
        const string = (0, change_case_1.changeCase)('my-component', 'pascalCase');
        expect(string).toEqual('MyComponent');
    });
    test('Kebabcase text renders in camel case', () => {
        const string = (0, change_case_1.changeCase)('my-component', 'camelCase');
        expect(string).toEqual('myComponent');
    });
    test('Kebabcase text renders in snake case', () => {
        const string = (0, change_case_1.changeCase)('my-component', 'snakeCase');
    ...
    test('Kebabcase text can handle more than 2 words', () => {
        const string = (0, change_case_1.changeCase)('my-component-with-five-words', 'sentenceCase');
...
describe('changeCase() convert from pascal case', () => {
    test('Pascalcase text renders in sentence case', () => {
        const string = (0, change_case_1.changeCase)('MyComponent', 'sentenceCase');
        expect(string).toEqual('My component');
    });
    test('Pascalcase text renders in kebab case', () => {
        const string = (0, change_case_1.changeCase)('MyComponent', 'kebabCase');
        expect(string).toEqual('my-component');
    });
    test('Pascalcase text renders in pascal case', () => {
        const string = (0, change_case_1.changeCase)('MyComponent', 'pascalCase');
        expect(string).toEqual('MyComponent');
    });
    test('Pascalcase text renders in camel case', () => {
        const string = (0, change_case_1.changeCase)('MyComponent', 'camelCase');
        expect(string).toEqual('myComponent');
    });
    test('Pascalcase text renders in snake case', () => {
        const string = (0, change_case_1.changeCase)('MyComponent', 'snakeCase');
        expect(string).toEqual('my_component');
    });
    ...
    test('Pascalcase text can handle more than 2 words', () => {
        const string = (0, change_case_1.changeCase)('MyComponentWithFiveWords', 'sentenceCase');
        expect(string).toEqual('My component with five words');
    });
});
...
describe('changeCase() convert from snake case', () => {
    test('Snakecase text renders in sentence case', () => {
        const string = (0, change_case_1.changeCase)('my_component', 'sentenceCase');
        expect(string).toEqual('My component');
    });
    test('Snakecase text renders in kebab case', () => {
        const string = (0, change_case_1.changeCase)('my_component', 'kebabCase');
        expect(string).toEqual('my-component');
    });
    test('Snakecase text renders in pascal case', () => {
        const string = (0, change_case_1.changeCase)('my_component', 'pascalCase');
        expect(string).toEqual('MyComponent');
    });
    test('Snakecase text renders in camel case', () => {
        const string = (0, change_case_1.changeCase)('my_component', 'camelCase');
        expect(string).toEqual('myComponent');
    });
    test('Snakecase text renders in snake case', () => {
        const string = (0, change_case_1.changeCase)('my_component', 'snakeCase');
        expect(string).toEqual('my_component');
    });
    ...
    test('Snakecase text can handle more than 2 words', () => {
        const string = (0, change_case_1.changeCase)('my_component_with_five_words', 'sentenceCase');
        expect(string).toEqual('My component with five words');
    });
