...
export const Home: NextPage = () => {
  ...
  return (
    <MainTemplate user={user}>
      <Grid columns={1}>
        <h2 className={styles['page-header']}><strong>Build your entire application (or just parts of it) from config.</strong> A stupidly simple command line tool.</h2>
      </Grid>
      <Grid columns={3}>
        <Card>
          <Card.Header>
            <h3 className={styles['card-header']}>Generate something new from a Scaffold</h3>
          </Card.Header>
          <Card.Body>
        ...
        <Card>
          <Card.Header>
            <h3 className={styles['card-header']}>Generate something pre-made from a Prefab</h3>
          </Card.Header>
          <Card.Body>
        ...
        <Card>
          <Card.Header>
            <h3 className={styles['card-header']}>Your entire application, built from config.</h3>
          </Card.Header>
          <Card.Body>
