...
exports.default = [
    ...
    },
    {
        type: 'list',
        name: 'useTSInline',
        message: 'Would you prefer to have your types in a separate file or have them inline with the component file?',
    ...
    },
    {
        type: 'list',
        name: 'testType',
        message: "Do you want to generate 'spec' or 'test' files? (e.g. example.spec.js/ts or example.test.js/ts)",
        choices: ['test', 'spec'],
        when: (answers) => answers.createTests,
        default: 'test'
    },
    {
        type: 'input',
        name: 'createDirectories',
        message: 'If you want extra directories to be created with each component, type them here separated by commas. If not, leave it blank',
        default: ''
    },
    {
        type: 'confirm',
        name: 'createReadme',
        message: 'Do you want to generate a basic README.md file for each component? (Not needed for Storybook MDX but recommended for CSF) ',
        default: true
    },
    {
        type: 'confirm',
